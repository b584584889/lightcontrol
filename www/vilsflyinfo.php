...
<html lang="en">
  <head>
    ...
    <title>SMIMS VILS IoT - Fly Info</title>
  </head>
        ...
        <div class="box-header with-border">
          ...
          <div class="box-tools pull-right">
              ...
              <ul class="pagination pagination-sm no-margin pull-right">
                <li>
                  <button type="button" class="btn btn-box-tool" onclick="open_flyinfo_page();return false;"><i class="fa fa-external-link"></i>
                  </button>
                </li>
              </ul>
          </div>
    ...
    <script src="/js/flyinfo_src/00-flyinfo.js?date=<?php echo $UPDATE_DATE;?>"></script>
