...
function update_user_area()
{
    ...
    for	(var index = 0; index < glUserActivity_List.length; index++)
    {
        ...
        // console.log("update_user_area() chartID:" + chartID);
        //
...
function fetch_rollcall(areaId, areaName)
{
    ...
    // start load location
    //
    load_rollcall_Tags_Info(areaId, areaName);
...
function show_rollcall_info()
{
    ...
    var showmsg = "區域:"+gl_rollcall_areaname+ "<br>實到:"+gl_rollcall_area_tag.length;
...
function load_rollcall_Tags_Info(areaId, areaName)
{
