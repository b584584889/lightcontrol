...
_onMouseOut:function(){this._container&&(this._container.style.visibility="hidden")}});(function(){var a={km:2,ha:2,m:0,mi:2,ac:2,yd:0,ft:0,nm:2};L.GeometryUtil=L.extend(L.GeometryUtil||{},{geodesicArea:function(a){var c=a.length,d=0,e=Math.PI/180,f,g;if(2<c){for(var h=0;h<c;h++)f=a[h],g=a[(h+1)%c],d+=(g.lng-f.lng)*e*(2+Math.sin(f.lat*e)+Math.sin(g.lat*e));d=40680631590769*d/2}return Math.abs(d)},formattedNumber:function(a,c){var d=parseFloat(a).toFixed(c),e=L.drawLocal.format&&L.drawLocal.format.numeric,f=e&&e.delimiters,e=f&&f.thousands,f=f&&f.decimal;if(e||f){var g=d.split("."),
d=e?g[0].replace(/(\d)(?=(\d{3})+(?!\d))/g,"$1"+e):g[0];1<g.length&&(d=d+(f||".")+g[1])}return d},readableArea:function(b,c,d){var e;d=L.Util.extend({},a,d);c?(e=["ha","m"],type=typeof c,"string"===type?e=[c]:"boolean"!==type&&(e=c),b=1E6<=b&&-1!==e.indexOf("km")?L.GeometryUtil.formattedNumber(1E-6*b,d.km)+" km\u00b2":1E4<=b&&-1!==e.indexOf("ha")?L.GeometryUtil.formattedNumber(1E-4*b,d.ha)+" ha":L.GeometryUtil.formattedNumber(b,d.m)+" m\u00b2"):(b/=.836127,b=3097600<=b?L.GeometryUtil.formattedNumber(b/
...
text:L.drawLocal.draw.toolbar.actions.text,callback:this.disable,context:this}]},setOptions:function(a){L.setOptions(this,a);for(var b in this._modes)this._modes.hasOwnProperty(b)&&a.hasOwnProperty(b)&&this._modes[b].handler.setOptions(a[b])}});L.Draw=L.Draw||{};
L.Draw.Feature=L.Handler.extend({initialize:function(a,b){this._map=a;this._container=a._container;this._overlayPane=a._panes.overlayPane;this._popupPane=a._panes.popupPane;b&&b.shapeOptions&&(b.shapeOptions=L.Util.extend({},this.options.shapeOptions,b.shapeOptions));L.setOptions(this,b);var c=L.version.split(".");1===parseInt(c[0],10)&&2<=parseInt(c[1],10)?L.Draw.Feature.include(L.Evented.prototype):L.Draw.Feature.include(L.Mixin.Events)},enable:function(){this._enabled||(L.Handler.prototype.enable.call(this),this.fire("enabled",
...
a instanceof L.Polygon||a instanceof L.Rectangle?a.setLatLngs(this._uneditedLayerProps[b].latlngs):a instanceof L.Circle?(a.setLatLng(this._uneditedLayerProps[b].latlng),a.setRadius(this._uneditedLayerProps[b].radius)):(a instanceof L.Marker||a instanceof L.CircleMarker)&&a.setLatLng(this._uneditedLayerProps[b].latlng),a.fire("revert-edited",{layer:a}))},_enableLayerEdit:function(a){a=a.layer||a.target||a;var b;this._backupLayer(a);this.options.poly&&(b=L.Util.extend({},this.options.poly),a.options.poly=
...
1E3)}}this._poly._bounds._southWest=L.latLng(Infinity,Infinity);this._poly._bounds._northEast=L.latLng(-Infinity,-Infinity);a=this._poly.getLatLngs();this._poly._convertLatLngs(a,!0);this._poly.redraw();this._poly.fire("editdrag")},_onMarkerClick:function(a){var b=L.Polygon&&this._poly instanceof L.Polygon?4:3;a=a.target;this._defaultShape().length<b||(this._removeMarker(a),this._updatePrevNext(a._prev,a._next),a._middleLeft&&this._markerGroup.removeLayer(a._middleLeft),a._middleRight&&this._markerGroup.removeLayer(a._middleRight),
a._prev&&a._next?this._createMiddleMarker(a._prev,a._next):a._prev?a._next||(a._prev._middleRight=null):a._next._middleLeft=null,this._fireEdit())},_onContextMenu:function(a){this._poly._map.fire(L.Draw.Event.MARKERCONTEXT,{marker:a.target,layers:this._markerGroup,poly:this._poly});L.DomEvent.stopPropagation},_onTouchMove:function(a){var b=this._map.mouseEventToLayerPoint(a.originalEvent.touches[0]),b=this._map.layerPointToLatLng(b);a=a.target;L.extend(a._origLatLng,b);a._middleLeft&&a._middleLeft.setLatLng(this._getMiddleLatLng(a._prev,
a));a._middleRight&&a._middleRight.setLatLng(this._getMiddleLatLng(a,a._next));this._poly.redraw();this.updateMarkers()},_updateIndexes:function(a,b){this._markerGroup.eachLayer(function(c){c._index>a&&(c._index+=b)})},_createMiddleMarker:function(a,b){var c=this._getMiddleLatLng(a,b),d=this._createMarker(c),e,f,g;d.setOpacity(.6);a._middleRight=b._middleLeft=d;f=function(){d.off("touchmove",f,this);var g=b._index;d._index=g;d.off("click",e,this).on("click",this._onMarkerClick,this);c.lat=d.getLatLng().lat;
c.lng=d.getLatLng().lng;this._spliceLatLngs(g,0,c);this._markers.splice(g,0,d);d.setOpacity(1);this._updateIndexes(g,1);b._index++;this._updatePrevNext(a,d);this._updatePrevNext(d,b);this._poly.fire("editstart")};g=function(){d.off("dragstart",f,this);d.off("dragend",g,this);d.off("touchmove",f,this);this._createMiddleMarker(a,d);this._createMiddleMarker(d,b)};e=function(){f.call(this);g.call(this);this._fireEdit()};d.on("click",e,this).on("dragstart",f,this).on("dragend",g,this).on("touchmove",f,
this);this._markerGroup.addLayer(d)},_updatePrevNext:function(a,b){a&&(a._next=b);b&&(b._prev=a)},_getMiddleLatLng:function(a,b){var c=this._poly._map,d=c.project(a.getLatLng()),e=c.project(b.getLatLng());return c.unproject(d._add(e)._divideBy(2))}});
...
new L.Marker.Touch(a,{draggable:!0,icon:b,zIndexOffset:10});this._bindMarker(c);this._markerGroup.addLayer(c);return c},_bindMarker:function(a){a.on("dragstart",this._onMarkerDragStart,this).on("drag",this._onMarkerDrag,this).on("dragend",this._onMarkerDragEnd,this).on("touchstart",this._onTouchStart,this).on("touchmove",this._onTouchMove,this).on("MSPointerMove",this._onTouchMove,this).on("touchend",this._onTouchEnd,this).on("MSPointerUp",this._onTouchEnd,this)},_unbindMarker:function(a){a.off("dragstart",
...
L.Circle.addInitHook(function(){L.Edit.Circle&&(this.editing=new L.Edit.Circle(this),this.options.editable&&this.editing.enable());this.on("add",function(){this.editing&&this.editing.enabled()&&this.editing.addHooks()});this.on("remove",function(){this.editing&&this.editing.enabled()&&this.editing.removeHooks()})});
