...
var Indoor2DMap = function(mapid)
{
    ...
    this.SHOW_LOCATOR_DEFAULT = true;
	...
	*/
    ...
    Indoor2DMap.prototype.fadeout_tag_footprint = function(tag_node_id, maplayer)
    {
        ...
        // console.log("fadeout_tag_footprint() tag_node_id:" + tag_node_id);

        if (TagFadeOutNodes == null || TagFadeOutNodes == undefined)
        {
            // console.log("fadeout_tag_footprint() failed! tag_node_id:" + tag_node_id);
            return;
        }
        ...
        for(var i=0;i<TagFadeOutNodes.length;i++)
        {
            ...
            if (old_radius <= 0.5 || this.mShowTrack == false)
            {
        ...
        for	(index = 0; index < nodeList.length; index++)
        {
            ...
            if ( exist_node.nodeid === nodeid )
            {
                ...
                if (updateUI)
                {
                    ...
                    // console.log("updateMarker() nodeid:"+ exist_node.nodeid +" fadeoutFootprint:"+fadeoutFootprint +" mShowTrack:"+this.mShowTrack);
                    ...
                    if (fadeoutFootprint && this.mShowTrack)
                    {
                        ...
                        // console.log("updateMarker() FadeOutNodes nodeid:"+ exist_node.nodeid +" TagFadeOutNodes:" + TagFadeOutNodes);
                    }
                }
                found = true;
                break;
    ...
    Indoor2DMap.prototype.load_allmaparea = function(orig_this)
    {
        ...
        {
            // console.log("load_allmaparea data="+data);
        ...
        for	(var index = 0; index < orig_this.TagDrawList.length; index++)
        {
    		...
    		if ( distance >= 5 || exist_node.not_move_count > 10)
            {
                ...
                else
                {
                    ...
                    // console.log("draw_tag_smooth_move() updateMarker nodeid:"+exist_node.nodeid +" move_loop_count:" + orig_this.move_loop_count);
