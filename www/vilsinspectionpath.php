...
<html lang="en">
  <head>
    ...
    <title>SMIMS VILS IoT - <?php echo $vilsinspectionpath_setting_title;?></title>
  </head>
    ...
    <div class="col-md-12 col-sd-12">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title"><?php echo $vilsinspectionpath_setting_title;?></h3>
          <div class="box-tools pull-right">
              <button type="button" class="btn btn-box-tool" onclick="open_inspection_page();return false;"><i class="fa fa-external-link"></i>
              </button>
        ...
        <!-- /.box-header -->
          ...
          <div class="box-body">
              ...
              <!-- nav-tabs-custom -->
              <div id="INSPECTION_TABLE_MSG"><?php echo $vilsinspectionpath_loading;?></div>
          </div>
          <!-- /.box-body -->
        </div>
        <!-- /.box-->
