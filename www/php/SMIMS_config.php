<?php
    ...
    $login_tilte = '北瀚科技</br>UWB室內定位 與</br>LoRA緊急呼叫系統';
    ...
    $unlockpage_buy = '購買';
    $unlockpage_verifykey = '機器驗證碼(共8碼)';
    $unlockpage_registerdevice = '新增點名器 ';
    $unlockpage_registertag = '新增標籤';
    $unlockpage_registeranchor = '新增基站';
    $unlockpage_registercoord = '新增閘道';
    $unlockpage_registerlocator = '新增LoRa Locator';
    $unlockpage_registercelllocator = '新增Cellular Locator';
    $unlockpage_registerwifilocator = '新增WIFI Locator';
    $unlockpage_registeredgecontol = '新增Edge Locator';
    $unlockpage_registeruhfreader = '新增UHF感應器';
    $unlockpage_registerloragateway = '新增LoRA Gateway';
    $unlockpage_registersensordevice = '新增傳感器';

    $page_tilte = 'SMIMS VILS IPS Solutions';
    $main_show_logo = false;
    $main_logo_file = '';
    $main_logo_small_file = 'VILS_logo_s.jpg';
    $main_logo_width = '220';
    ...
    $left_side_bar_userregister = '人員註冊';
    ...
    $left_side_bar_devices_fieldcontrol = '人員現場管制';
    $left_side_bar_devices_firefighting = '火場紀錄';
    $left_side_bar_devices_activity = '物聯網';
    $left_side_bar_devices_maintenance = '裝置履歷';
    $left_side_bar_devices_versionhistory = '版本紀錄';
    ...
    $left_side_bar_curriculum = '學校課程';
    $left_side_bar_curriculum_list = '課程發起';
    $left_side_bar_curriculum_records = '課程編輯';
    ...
    $left_side_bar_scotttest = 'MQTT應用';
    $left_side_bar_eventreport = '穩態裝置事件彙總表';
    $left_side_bar_powermeterview = '智慧電表監控';
    $left_side_bar_lightdevicecontrol = '智慧光源裝置控管';
    $left_side_bar_watchlocation = '智慧手錶監控';
    ...
    $vilsdevices_sensors = '傳感器';
    $vilsdevices_beacon = 'beacon';
    ...
    $vilssensordevice_alive = '活動';
    $vilssensordevice_id = 'ID';
    $vilssensordevice_name = '名稱';
    $vilssensordevice_type = '類別';
    $vilssensordevice_LngLat = '經緯度';
    $vilssensordevice_Battery = '電壓';
    $vilssensordevice_info = '資訊';
    $vilssensordevice_version = '版本';
    $vilssensordevice_operation = '操作';
    ...
    $vilsscott_other = '事件';
    $vilsscott_light = '藍芽燈泡';
    $vilsscott_uw = '微波';
    $vilsscott_watch = '智慧手錶';
    $vilsscott_pm = '智慧電錶';
    ...
    $vilscurriculum_title = '課程發起';
    $vilscurriculumcode_edit = '課程號碼管理';
    $vilscurriculumcode_shared = '共享課程管理';
    $vilscurriculum_createnew = '新增學校課程';

    $vilscurriculumtype_title = '課程類別設定';
    $vilscurriculumtype_createnew = '新增課程類別';

    $vilscurriculumrecord_title = '課程編輯';
    $vilscurriculum_applynew = '新增課程';
    ...
    $vilsuserinfo_sensors = '傳感器';
    $vilsuserinfo_creatnewuser = '新增人員';
    $vilsuserinfo_operation = '操作';

    $vilsuserregister_title = '人員註冊列表';
    $vilsuserregister_subgroupname = '主集合名稱';
    $vilsuserregister_email = 'email';
    $vilsuserregister_valid = '註冊狀態';
    $vilsuserregister_send = '傳送註冊信件次數';
    $vilsuserregister_datetime = '註冊時間';
    $vilsuserregister_operation = '操作';
    ...
    $vilsusermaingroupinfo_welcommessage = '歡迎詞';
    $vilsusermaingroupinfo_photo = '照片';
    $vilsusermaingroupinfo_autojoin = '自動加入功能';
    ...
    $vilsactivity_name = '名稱 ';
    $vilsactivity_value = '資料值 ';
    $vilsactivity_distance = '距離';

    $firefighting_create = '新增消防火場';
    $firefighting_record = '紀錄消防火場';
    $firefighting_history = '歷史消防火場';
    $firefighting_report = '報表';
    ...
    $vilsevnetreport_title = '事件彙總表';
    $vilsevnetreport_title2 = '智慧電表監控';
    $vilslightdevicecontrol_title = '智慧光源裝置控管';
    $vilswatchlocation_title = '智慧手錶定位監測';
    ...
    $vilssensor_report_title = '傳感器報告';
    $vilssensor_daily_report = '日報表';
    $vilssensor_weekly_report = '週報表';
    $vilssensor_monthly_report = '月報表';
    $vilssensor_generate_report = '產生報表';
?>
