<?php
    ...
    $login_tilte = '屏東縣政府消防局</br><label style="color:#ff0000">火場管制系統</label>';
    ...
    $main_short_text = '火場管制系統';
    $main_title_prefix_text = '屏東縣政府消防局';
    $main_title_text = '火場管制系統';
    $main_bottom_title = '屏東縣消防局火場管制系統';
