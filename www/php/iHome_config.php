<?php
    ...
    $login_tilte = 'UWB室內定位 與</br>LoRa緊急呼叫系統';
    ...
    $main_copyright_name = 'Copyright &copy; 2019 <a href="http://smims.com.tw">SMIMS Corp</a>.';
    ...
    $left_side_bar_devices_activity = '活動狀態';
    $left_side_bar_devices_maintenance = '裝置履歷';

    $left_side_bar_courses = '課程';
    $left_side_bar_courses_list = '課程表';
