...
<html lang="en">
  <head>
    ...
    <title>SMIMS VILS IoT - <?php echo $left_side_bar_weekschedule_list; ?></title>
  </head>
  ...
  <div class="col-md-12 col-sd-12">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title"><?php echo $left_side_bar_weekschedule_list; ?></h3>
          <div class="box-tools pull-right">
              <button type="button" class="btn btn-box-tool" onclick="edit_mode();return false;"><i class="fa fa-edit"></i>
              </button>
              <button type="button" class="btn btn-box-tool" onclick="open_weekschedule_page();return false;"><i class="fa fa-external-link"></i>
              </button>
          </div>
        </div>
        <!-- /.box-header -->
