...
<html lang="en">
  <head>
    ...
    <title>SMIMS VILS IoT - RFID Card RollCall Record</title>
  </head>
        ...
        <div class="box-header with-border">
            ...
            <div class="box-tools pull-right">
                ...
                <ul class="pagination pagination-sm no-margin pull-right">
                  <li>
                    <button type="button" class="btn btn-box-tool" onclick="open_cardrollcallrecord_page();return false;"><i class="fa fa-external-link"></i>
                    </button>
                </li>
              </ul>
            </div>
